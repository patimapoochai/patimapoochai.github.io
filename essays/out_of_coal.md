...
Web development is often overlooked compared to other fields in the tech field. Looking at [Glassdoor](https://www.glassdoor.com/index.htm), a job statistic site, a web developer receives only 68,000 dollars a year compared to a more technical Data engineer position of 106,000 dollars per year. Despite the gap in salary, there are many software development projects that hire a web developer. One way or another, you’d end up working on a web application. Maybe you are between jobs and need to earn some money, or you are trying to earn your college degree and need to take a web development class. Either way, many software engineers would at least cross paths with web development at some point.
