...
<div>
  <div class="ui Huge center rounded image">
    ...
    <div class="ui bottom attached label">
          Accelerated Back Hopping (ABH) is a speedrunning strategy in which a player performs backward hops (bunny hopping) to surpass the intended movement speed of Source engine games. This movement is slow and hard to master, but it has the potential to be the fastest form of transportation. Setting up a correct position, speed, and inputs for ABH could make or break a world record for speedruns.
        </div>
  </div>
</div>
